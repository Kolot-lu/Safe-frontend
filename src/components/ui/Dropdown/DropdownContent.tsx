 ...
 */
export const DropdownContent: React.FC<{children: ReactNode, position?: "left" | "right", closeOnClisk?: boolean; className?: string }> = ({
  children,
  position = "right",
  closeOnClisk = true,
  className
  ...
  return (
    (isAnimating || context.isOpen) && (
      <div
        ...
        className={cn(
          'absolute mt-2 w-fit rounded-md flex flex-col gap-2 p-3 bg-gray-100/30 dark:bg-dark-400/30 backdrop-blur-xl border border-border-light dark:border-border-dark z-[100]',
          {
            left: 'left-0',
            right: 'right-0',
          }[position],
